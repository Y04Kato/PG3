...
int main() {
	...
	printf("配列を学籍番号順に並び替え、表示\n");
	for (int iterator = 0; iterator < studentNo.size(); iterator++) {
		printf("%s\n", studentNo[iterator]);
	}
